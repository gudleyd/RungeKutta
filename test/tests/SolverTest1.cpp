...
int uni_test_1(std::ostream& out, 
               std::ostream& logFile,
               std::vector<std::vector<long double>> butcherTable) {
    out << "Running UNI test 1\n";
    size_t errCount = 0;
    {   /*  SOLVE TESTS */
        ...
        out << "\nRunning system solve tests...\n";
        {
            ...
            */
            ...
            tmpErrCount += ssTest0.run_solve_test({-0.5, 1.60653, 5}, butcherTable, 0.00001, logFile);
        }
        {
            /* 
                y' = 2y - z - 1
            ...
            */
            ...
            tmpErrCount += ssTest1.run_solve_test({-0.5, 1.97441, 1.60653}, butcherTable, 0.00001, logFile);
        }
